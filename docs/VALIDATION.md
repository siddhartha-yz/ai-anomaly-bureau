...
- Vitest：23 个测试文件、121 个测试全部通过。
- Vite production build：通过；当前冻结 runtime 构建为 `assets/index-DAklORcC.js` + `assets/index-lQM9_nnH.css`（生产发布后再记录远端哈希）。
