...
import { STORY_SESSION_VERSION, readStorySession, storyAuditCredits, storySessionHasProgress, writeStorySession } from '../game/session'
...
export function StoryCase001Runtime({ seed, onRestart, onReturnToBureau, onCaseClosed }: {
  seed: number
  onRestart: () => void
