...
import { FORMAL_CASE_CATALOG, STORY_CASE_001, STORY_CASE_002, STORY_CASE_003, STORY_CASE_004, TRAINING_CASE_CATALOG, TRAINING_CASE_000, formalCaseCode, trainingCaseCode } from '../src/bureau/catalog'

describe('Bureau authored case catalog', () => {
  it('registers a real authored-case progression instead of a single-case shell', () => {
    expect(FORMAL_CASE_CATALOG).toEqual([STORY_CASE_001, STORY_CASE_002, STORY_CASE_003, STORY_CASE_004])
  ...
  it('keeps training content in a separate catalog from the authored CASE 002/003/004 progression', () => {
