...
import { FORMAL_CASE_CATALOG, STORY_CASE_001, STORY_CASE_002, STORY_CASE_003, STORY_CASE_004, STORY_CASE_005, TRAINING_CASE_CATALOG, TRAINING_CASE_000, formalCaseCode, trainingCaseCode } from '../src/bureau/catalog'

describe('Bureau authored case catalog', () => {
  it('registers a real authored-case progression instead of a single-case shell', () => {
    expect(FORMAL_CASE_CATALOG).toEqual([STORY_CASE_001, STORY_CASE_002, STORY_CASE_003, STORY_CASE_004, STORY_CASE_005])
    ...
    expect(formalCaseCode(STORY_CASE_004)).toBe('CASE 004')
    expect(formalCaseCode(STORY_CASE_005)).toBe('CASE 005')
    expect(STORY_CASE_002.unlockAfter).toBe(STORY_CASE_001.id)
    expect(STORY_CASE_003.unlockAfter).toBe(STORY_CASE_002.id)
    expect(STORY_CASE_004.unlockAfter).toBe(STORY_CASE_003.id)
    expect(STORY_CASE_005.unlockAfter).toBe(STORY_CASE_004.id)
  })
  ...
  it('keeps training content in a separate catalog from the authored CASE 002/003/004/005 progression', () => {
